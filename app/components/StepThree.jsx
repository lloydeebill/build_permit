  ...
  return (
    <div className="container mx-auto px-4 py-4 bg-slate-100">
      <div className="flex flex-wrap -mx-2 gap">
        <div className="w-full md:w-1/2 px-4 border border-transparent border-r-gray-300"> 
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block text-sm pl-0 py-5 font-semibold text-gray-700">
              Scope of Work:
            </label>
        ...
        <div className="w-full md:w-1/2 px-4 border border-transparent border-l-gray-300 ">
          <div className="mb-4">
