  ...
  return (
    <div className="container mx-auto px-4 py-4">
      <div className="flex flex-wrap -mx-2">
        {/* Left Column */}
        <div className="w-full md:w-1/2 px-2 mb-4 border-2 border-gray-300 rounded-md">
          <div className="mb-4">
          ...
          <div className="mb-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="tctNo" className="block text-sm font-medium text-gray-700">
                TCT No.
              </label>
              <input
                type="text"
          ...
          <div className="mb-4">
            <label htmlFor="structOwn" className="block text-sm font-medium text-gray-700">
          ...
          <div className="mb-4">
            <label htmlFor="FormOwner" className="block text-sm font-medium text-gray-700">
              Form of Ownership
            </label>
            <select
              id="FormOwner"
