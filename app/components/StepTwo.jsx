      ...
      <div className="flex flex-wrap -mx-2">
        ...
        <div className="w-full md:w-1/2 px-2">
          ...
          <div className="w-full px-2 pt-4 mb-4 border-2 border-gray-300  rounded-md md:ml-2">
            ...
            <div className="mb-4">
              <label htmlFor="extensionName" className="block text-sm font-semibold text-gray-700">
                Extension Name:
              </label>
              <input
                type="text"
            ...
            <div className="mb-4 grid grid-cols-3 gap-4">
              ...
              {/* House No. */}
              <div>
                <label htmlFor="houseNo" className="block text-sm font-semibold text-gray-700">
                  House No.:
                </label>
                <input
                  type="text"
        ...
        <div className="w-full md:w-1/2 px-4">
          ...
          <div className="w-full px-2 py-4 mb-4 border-2 border-gray-300 rounded-md md:mr-2">
            <div className="mb-4">
              <label htmlFor="tin" className="block text-sm font-semibold text-gray-700">
                TIN
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="GovernmentId" className="block text-sm font-semibold text-gray-700">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <label htmlFor="placeIssued" className="block text-sm font-semibold text-gray-700">
                  Place Issued: 
                </label>
                <input
                  type="text"
            ...
            <div className="mb-4">
              <label htmlFor="lotOwnerName" className="block text-sm font-semibold text-gray-700">
                Lot Owner&apos;s Fullname:
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="lotAddress" className="block text-sm font-semibold text-gray-700">
                Lot Address:
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="lotOwnerIdentification" className="block text-sm font-semibold text-gray-700">
